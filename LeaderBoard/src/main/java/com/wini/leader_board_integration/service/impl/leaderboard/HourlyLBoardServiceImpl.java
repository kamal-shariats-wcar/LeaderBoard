...
import com.wini.leader_board_integration.repository.HourRepository;
...
@Service
public class HourlyLBoardServiceImpl extends LeaderboardBaseService<Hour> {
    ...
    @Autowired
    public HourlyLBoardServiceImpl(HourRepository hourRepository, MongoTemplate mongoTemplate) {
    ...
    @Override
    public Hour save(Hour threeDays) {
        return hourRepository.save(threeDays);
    }

    @Override
    public Hour findLatest(String leaderboardId, String playerId) {
        return hourRepository.findDistinctTopByLeaderboardIdAndPlayerIdOrderByCreatedAtDescExpireAtDesc(leaderboardId, playerId);
    }
    ...
    public RankData rankFor(String leaderboardId, String playerId, List<String> keys, boolean includeCountry) {
         ...
         */
        Hour currentPlayer = hourRepository.findDistinctTopByLeaderboardIdAndPlayerIdOrderByCreatedAtDescExpireAtDesc(leaderboardId, playerId);
        ...
        if (currentPlayer != null) {
            ...
            AggregationResults<Hour> result = mongoTemplate.aggregate(aggregation, Hour.class, Hour.class);
    ...
    public List<RankData> top(String leaderboardId, String country, int size) {
        ...
        for (Hour threeDays : result.getMappedResults()) {
    ...
    public List<RankData> topMe(String leaderboardId, RankData playerRank, List<String> keys, boolean includeCountry, int size) {
        ...
        AggregationResults<Hour> result = mongoTemplate.aggregate(topAggregation, Hour.class, Hour.class);
    ...
    public List<RankData> bottomMe(String leaderboardId, RankData playerRank, List<String> keys, boolean includeCountry, int size) {
        ...
        AggregationResults<Hour> result = mongoTemplate.aggregate(bottomAggregation, Hour.class, Hour.class);
    ...
    public int getLeaderboardType() {
        int a = ThreadLocalRandom.current().nextInt(1001, 50000);
        return a;
    }
